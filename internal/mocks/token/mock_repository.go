...
// Source: github.com/codigician/auth/internal/token (interfaces: Repository)
...
import (
	...
	token "github.com/codigician/auth/internal/token"
...
func (m *MockRepository) Get(arg0 context.Context, arg1 string) (*token.RefreshToken, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Save(arg0 context.Context, arg1 *token.RefreshToken) error {
	m.ctrl.T.Helper()
